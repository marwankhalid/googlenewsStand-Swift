...
struct AnimationConfig{
    ...
    init(
          cards:[Card]? = [Card.init(bgImage: "00.jpeg", strTitle: "", items: [Model(),Model(),Model()]),
                           
                           Card.init(bgImage: "11.jpeg", strTitle: "", items: [Model(),Model(),Model(),Model(),Model(),Model()]),
                           
                           Card.init(bgImage: "22.jpeg", strTitle: "", items: [Model(),Model(),Model(),Model()]),
                           
                           Card.init(bgImage: "33.jpeg", strTitle: "", items: [Model(),Model()] )
