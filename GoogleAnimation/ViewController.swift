...
class ViewController: UIViewController,AnimatorCardDelegate,AnimatorTableDelegate {
    ...
    func setView(){
        ...
        C.set(item: btnMenu, attri: .width, relatedBy:.equal, toItem: self.view, attribute: .height, multiplier: 0.08, constant: 0, viewMain: self.view);
        ...
        textView.font = UIFont(name: "", size: 24)
        textView.textColor = .red
        
    
         //1. initialize animator
        Animator.shared.setAnimator(UIImage.init(named: "h.jpeg"), self.view)
